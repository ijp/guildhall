...
(library (sigil ext trc-testing parameters)
  (export
    with-test-case-run
    with-test-suite-run
    niladic-test
  ...
  (import (rnrs)
          (srfi :39 parameters)
          (sigil ext trc-testing limited-write)
          (sigil ext trc-testing display-condition)
          (sigil ext trc-testing port-tracker)
          (sigil ext trc-testing restart))
