...
(library (sigil ext fmt)
  ...
  (include-from-path "sigil/ext/inc/mantissa")
  (include-from-path "sigil/ext/inc/fmt")
  (include-from-path "sigil/ext/inc/fmt-pretty")
  (include-from-path "sigil/ext/inc/fmt-column"))
