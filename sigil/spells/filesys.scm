...
;;
;;  library accepts pathnames, for which @pxref{(sigil spells
;; pathname)}.
(library (sigil spells filesys)
  (export file-exists?
          create-directory
          create-directory*
          delete-file
  ...
  ;; First, (sigil spells filesys compat) is inlined here.
...
;; directory contents.  @xref{Top,,the foof-loop documentation,(sigil ext
...
;; used with @ref{(sigil spells string-utils)
