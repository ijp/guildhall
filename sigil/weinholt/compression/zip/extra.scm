...
;; Guile-dependent hooks for (sigil weinholt compression zip).  Based on the
;; hooks for Ikarus.

(library (sigil weinholt compression zip extra (0 0 20100411))
