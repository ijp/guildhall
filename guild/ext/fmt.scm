;;; fmt.scm --- R6RS library for the fmt core
;;
...
(library (guild ext fmt)
  ...
  (include-from-path "guild/ext/inc/mantissa")
  (include-from-path "guild/ext/inc/fmt")
  (include-from-path "guild/ext/inc/fmt-pretty")
  (include-from-path "guild/ext/inc/fmt-column"))
