...
(library (sigil weinholt compression zip (0 0 20101007))
  ...
  (import (rnrs)
          ...
          (only (srfi :13 strings) string-prefix? string-suffix?
                string-contains)
          (srfi :19 time)
          (sigil weinholt struct pack (1 (>= 3)))
          (sigil weinholt crypto crc (1 (>= 0)))
          (sigil weinholt compression inflate (1))
          (sigil weinholt compression zip extra (0 (>= 0))))
