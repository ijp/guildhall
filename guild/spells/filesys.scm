...
;;
;;  library accepts pathnames, for which @pxref{(guild spells
;; pathname)}.
(library (guild spells filesys)
  (export file-exists?
          create-directory
          create-directory*
          delete-file
  ...
  ;; First, (guild spells filesys compat) is inlined here.
...
;; directory contents.  @xref{Top,,the foof-loop documentation,(guild ext
...
;; used with @ref{(guild spells string-utils)
