...
(library (guild weinholt compression zip (0 0 20101007))
  ...
  (import (rnrs)
          ...
          (only (srfi :13 strings) string-prefix? string-suffix?
                string-contains)
          (srfi :19 time)
          (guild weinholt struct pack (1 (>= 3)))
          (guild weinholt crypto crc (1 (>= 0)))
          (guild weinholt compression inflate (1))
          (guild weinholt compression zip extra (0 (>= 0))))
